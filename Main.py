...
# Instagram Scraper
# Coded by Scianto 
# http://github.com/Scianto/INSTAINFO
...
def parse_args():
    parser = argparse.ArgumentParser(description="INSTAINFO tool")
...
def main():
    ...
    if args.username[0].strip() == '':
        ...
        INFO = INSTAINFO (username=args.username[0], downloadPhotos=args.downloadPhotos)
